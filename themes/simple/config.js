const CONFIG = {
  ...
  SIMPLE_LOGO_DESCRIPTION: process.env.NEXT_PUBLIC_THEME_SIMPLE_LOGO_DESCRIPTION || '<div>M.Sc. Cybersecurity in Saarland University<br/>B.Eng Information Engineering in CUHK</div>',
